    ...
    */
    ...
    $('#btnLogin').click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                        if(data.redirect!==''){
                            // Connexion à l'application si identifiants corrects
                            window.location.href = data.redirect;
                        }else{
                            $('.loginresponse').text('Aucun utilisateur/mot de passe ne correspond à ces identifiants. Veuillez vérifiez les champs.');
...
/* Fonction qui affiche les boîtes de dialogues. S'y trouvent aussi les requêtes
 * d'ajout, de modification et suppresion des différents élèments (tâches, classeurs, titres) */
                                ...
                                buttons: {
                                    "Enregistrer": function() {
                                        ...
                                        $.ajax({
                                            ...
                                            error: function(data){
                                                console.log(data);
                                                $('#.loginresponse').replaceWith(data.responseText);
                                            }
                                        });
                                    },
                                    Annuler: function() {
